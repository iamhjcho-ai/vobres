...
class MainApp:
	...
	def get_chat_updates(self, timeout=10):		# 260603 timeout 추가
		"""텔레그램 채팅 업데이트를 가져옵니다."""
		try:
			params = {
	...
	async def run(self):
		"""메인 실행 루프"""
		print("check_market_timing과 텔레그램 모니터링 get_chat_updates()를 시작합니다...")
		...
		try:
			while self.keep_running:
				...
				if message == 'power off':
					...
					self.get_chat_updates(timeout=1)	# 'update_id' 갱신
